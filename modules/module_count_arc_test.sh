...
ALL_LIBS="/cfs/klemming/projects/snic/sllstore2017078/marwe445-workingdir/samples_info/sample_1/libs.csv"
...
for SAMPLE in "${SAMPLES[@]}"; do
    ...
    head -n 1 "$ALL_LIBS" | awk -F, -v OFS=',' '{print $1, $2, $3}' > "$LIBS"

    # Append the rows matching the current SAMPLE to the LIBS file
    awk -F, -v OFS=',' -v SAMPLE="$SAMPLE" '$2 == SAMPLE {print $1, $2, $3}' "$ALL_LIBS" >> "$LIBS"
